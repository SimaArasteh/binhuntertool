...
with open('data/trees_v4.pkl', 'rb') as f:
    trees = pkl.load(f)
...
from models import MultiplicativeRecursiveNN, Config, Var
...
gen_model = MultiplicativeRecursiveNN(vocab, gen_config).cuda()

train(model, gen_model, "Gen_experiment_mul", ctrain, ctest, gtrain, gval, gtest, sc=False, print_every=5000)
